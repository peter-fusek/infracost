...
- Pages: 14 total (/, /breakdown, /trends, /optimizations, /countdown, /triage, /alerts, /analytics, /status, /platforms, /budgets, /manual, /verify, /reconciliation)
  ...
  - /reconciliation = cost_records sum vs invoices sum per platform/month; integrity checks (duplicates, missing periods); runs in daily cron; Turso invoices auto-ingested via API
